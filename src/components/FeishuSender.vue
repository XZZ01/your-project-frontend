...
const sendImmediate = async () => {
  ...
  try {
    const response = await axios.post('/api/send-batch-message', {
...
const loadScheduledTask = async () => {
  try {
    const response = await axios.get('/api/scheduled-task');
...
const saveScheduledTask = async () => {
  ...
  try {
    const response = await axios.post('/api/scheduled-task', payload);
...
const stopScheduledTask = async () => {
  try {
    const response = await axios.delete('/api/scheduled-task');
    scheduledResult.value = response.data;
